...
namespace Smartproj
{
    public struct PointD : IDistance<double>
    {
        ...
        {
            return $"({mPoints[0].ToString("0.000")}; {mPoints[1].ToString("0.000")}) #{Index}";
        }
    }
    public struct PointI : IDistance<int>
    {
        ...
        public new string ToString()
        {
            return $"({mPoints[0].ToString()}; {mPoints[1].ToString()}) #{Index}";
        }
    }
    public struct IntegerDistance : IDistance<int>
    {
        ...
        public IntegerDistance(int _point) : this(-1, _point) {}
        ...
        public new string ToString()
        {
            return $"({mPoints[0].ToString()}) #{Index}";
        }
    }
}
