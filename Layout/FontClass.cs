...
namespace Smartproj
{
    ...
    /// <summary>
    /// Класс для описания параметров шрифта. Класс не содержит в явном виде содержимого шрифта, только его свойства. Используется только для удобства передажи параметров шрифта, и их сериализации
