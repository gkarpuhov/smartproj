...
namespace Smartproj.Utils
{
    public class Tag
    {
        ...
        {
            "yyyy:MM:dd HH:mm:sszzz", "yyyy:MM:dd HH:mm:ss"
        };
        ...
        public Tag(string id, string name, string description, string tableName, string group, string value, string numberValue = null, IEnumerable<string> list = null)
        {
            Id = id;
            Name = name;
